...
local function loadKeys()
    local success, response = pcall(function()
        return HttpService:GetAsync("https://pastebin.com/raw/7DyZ9fmW")  -- Replace with your URL
    end)
    if success then
...
local function saveKeys()
    ...
    -- In a real setup, you'd POST this to your server
    -- For demo, just print it (you'd need a server to save)
    print("Key data to save: " .. json)
end
